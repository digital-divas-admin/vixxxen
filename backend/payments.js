...
router.post('/create-charge', async (req, res) => {
  try {
    ...
    const params = new URLSearchParams({
      ...
      callback_url: `${process.env.BACKEND_URL || 'https://vixxxen-6yn3.onrender.com'}/api/payments/webhook/plisio`,
      success_callback_url: `${process.env.FRONTEND_URL || 'https://vixxxen-6yn3.onrender.com'}?payment=success&tier=${tier}`,
      fail_callback_url: `${process.env.FRONTEND_URL || 'https://vixxxen-6yn3.onrender.com'}?payment=failed`,
